...
<body>
	...
	<ul>
		...
		<li class="active"><i class="fas fa-undo"></i>Retur</li>
	...
	<div class="content">
		<div class="col-6 left">
			...
			<?php if (!isset($_GET['p']) || $_GET['p']=='cari') { ?>
				<button class="sub" onclick="window.location.href='<?php echo site_url('retur') ?>?p=tambah';">Tambah</button>
			<?php } ?>
		</div>
		...
		<div class="col-12">
			<div class="box shadow">
					...
					<table>
						...
						<tbody>
							<?php
								$src = "SELECT * FROM stok WHERE catatan = 'Retur' ORDER BY tanggal DESC , id_stok DESC";
							...
							<tr>
								...
								<td align="center">
									<i onclick="window.location.href='<?php echo site_url('retur/viewitem') ?>?id=<?php echo $row->id_stok ?>';" class="fas fa-eye" title="Lihat"></i>
								</td>
							</tr>
							<?php } } ?>
						</tbody>
						...
						<tbody class="nohover">
							...
							<tr>
								...
								<td>
									...
									<button onclick="window.location.href='<?php echo site_url('retur') ?>';" class="sub cancel">Batal</button>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody class="nohover">
							...
							<tr>
								...
								<td>
									...
									<button onclick="window.location.href='<?php echo site_url('retur') ?>';" class="sub proses">Proses</button>
								</td>
							</tr>
							<tr>
								<td></td>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td align="center">
									<i onclick="window.location.href='<?php echo site_url('retur/hapusitem') ?>?id_stok=<?php echo $row->id_stok ?>&id_obat=<?php echo $row->id_obat ?>';" class="fas fa-eraser" title="Hapus"></i>
								</td>
							</tr>
							<?php } ?>
						</tbody>
					...
					<table>
						<tbody class="nohover">
							...
							<tr>
								...
								<td></td>
								<td>
									<button onclick="window.location.href='<?php echo site_url('retur') ?>';" class="sub cancel">Kembali</button>
								</td>
							</tr>
							<tr>
								<td></td>
	...
	<script>
		...
		$('#lanjut').click(function() {
			...
			$.ajax({
				type: 'post',
				url: '<?php echo base_url() ?>retur/tambah',
				dataType: 'json',
				data: { tgl: tgl, bln: bln, thn: thn, nama: nama },
				success: function(result) {
					window.location.href = '<?php echo base_url() ?>retur?p=item';
				}
			});			
		});
		$('#tambah').click(function() {
			...
			$.ajax({
				type: 'post',
				url: '<?php echo base_url() ?>retur/item',
				dataType: 'json',
